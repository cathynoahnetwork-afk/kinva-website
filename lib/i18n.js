...
window.KV.CONFIG = {
  ...
  brands: ["Faber-Castell", "M&G", "STABILO", "Pilot", "Nieki"],
};
...
window.KV.I18N = {
  ...
  zh: {
    ...
    home: {
      ...
      why: {
        overline: "为什么选择我们",
        title: "更低门槛，更有保障的批发伙伴",
        lead: "二十多年来，我们专注一件事：让普通人也能安心入货、轻松开店。",
        items: [
          { icon: "truck", title: "免费送货", text: "批量订单免运费，货直接送到你店门口，省去物流烦恼与额外成本。" },
          { icon: "rotate-ccw", title: "可退回保障", text: "卖不出？可退回。低风险入货，让你放心试销新品类、扩充货架。" },
          { icon: "wallet", title: "低门槛批发", text: "起订量低、价格友好。不必囤大量库存，也能享受批发价。" },
          { icon: "shield-check", title: "超过 25 年经验", text: "服务无数小本生意与杂货店东主，稳定供货，值得信赖的本地批发商。" },
        ],
      },
      services: {
        overline: "我们的服务",
